...
\restrict GRMdKetUJZWhlbs19dLUq0OvOA1NXAm74fut1SxA3yR50JzF9FIa1Kp6ehtSwhA
...
--
-- Name: enforce_album_release_date(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.enforce_album_release_date() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN
    IF EXISTS (
        SELECT 1
		FROM album_tracks at
        JOIN track_authors ta ON ta.track_id = at.track_id
        JOIN bands b ON b.id = ta.band_id
        WHERE a.id = NEW.id
          AND NEW.released < b.formed_date
    ) THEN
        RAISE EXCEPTION
            'Album % release date (%) is before band formation date',
            NEW.id, NEW.released;
    END IF;
...
ALTER FUNCTION public.enforce_album_release_date() OWNER TO postgres;

--
-- Name: enforce_track_release_date(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.enforce_track_release_date() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION
            'Track % release date (%) is before band formation date',
            NEW.id, NEW.released;
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION
            'Track % release date (%) is before artist birth date',
            NEW.id, NEW.released;
    END IF;
...
ALTER FUNCTION public.enforce_track_release_date() OWNER TO postgres;
...
--
-- Name: artist_band_tracks_while_member; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.artist_band_tracks_while_member AS
 SELECT p.name AS artist_name,
  ...
  WHERE ((t.released >= bm.joined) AND ((bm."left" IS NULL) OR (t.released <= bm."left")));


ALTER VIEW public.artist_band_tracks_while_member OWNER TO postgres;
...
--
-- Name: band_with_albums_and_tracks; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.band_with_albums_and_tracks OWNER TO postgres;
...
--
-- Name: band_members band_members_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.band_members
    ADD CONSTRAINT band_members_check CHECK ((joined < "left")) NOT VALID;
...
--
-- Name: people born_before_deceased; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.people
    ADD CONSTRAINT born_before_deceased CHECK ((born < deceased)) NOT VALID;
...
--
-- Name: albums positive_intervals; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.albums
    ADD CONSTRAINT positive_intervals CHECK ((duration >= '00:00:00'::interval)) NOT VALID;


--
-- Name: tracks positive_intervals; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: albums title_not_empty; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.albums
    ADD CONSTRAINT title_not_empty CHECK ((btrim(title) <> ''::text)) NOT VALID;


--
-- Name: tracks title_not_empty; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: album_tracks track_num_in_album_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.album_tracks
    ADD CONSTRAINT track_num_in_album_uniq UNIQUE (track_number, album_id);
...
--
-- Name: tracks_with_album_and_artists _RETURN; Type: RULE; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW public.tracks_with_album_and_artists AS
...
ALTER VIEW public.tracks_with_album_and_artists OWNER TO postgres;


--
-- Name: albums album_release_date_constraint; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE CONSTRAINT TRIGGER album_release_date_constraint AFTER INSERT OR UPDATE ON public.albums DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE FUNCTION public.enforce_album_release_date();
...
--
-- Name: tracks track_release_date_constraint; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE CONSTRAINT TRIGGER track_release_date_constraint AFTER INSERT OR UPDATE OF released ON public.tracks DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE FUNCTION public.enforce_track_release_date();
...
\unrestrict GRMdKetUJZWhlbs19dLUq0OvOA1NXAm74fut1SxA3yR50JzF9FIa1Kp6ehtSwhA
